...
export default class crunchCharacterSheet extends api.HandlebarsApplicationMixin(sheets.ActorSheetV2) {
    ...
    static PARTS = {
        ...
        header: { template: "systems/crunch/templates/sheets/character/header.hbs" },
        sidebar: { template: "systems/crunch/templates/sheets/character/sidebar.hbs" }
    }
